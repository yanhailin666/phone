...
"""
重构v2.0版本 2020-9-17
由于没有考虑到函数returm函数后面代码不运行，需要重构
每一个网站需要写一个函数然后统一符合进行调用
修改来源网站：tempUrl改为tempul_list
"""


def sms():
    url_list = ["http://www.z-sms.com",  "https://yunduanxin.net"]
    #短信url合集"https://www.materialtools.com/",无+86号码http://www.114sim.com/，登录有人机交互 "https://www.bfkdim.com/home",,"https://www.we39.cn/"
