		...
		<view class="uni-padding-wrap uni-common-mt">
			<form @submit="formSubmit">
				...
				<view class="index-page">
					<button form-type="submit" @click="showMenu">GPS分享</button>
					...
					uni.getSystemInfo({
						success: function (res) {
							...
							uni.share({
								...
								title: 'djfi',//data2.title,
								summary:'dfh',//data2.content,//"我正在使用HBuilderX开发uni-app，赶紧跟我一起来体验！",//当作唯一标识
								...
								complete: function (res) {
									...
									uni.request({
										...
										//data:params,
										data: {
											"title":'difj',//data2.title,
											noncestr: 'yanhailin',
											"content":'dfb',//data2.content,
											"brand":brand,
											"model":model
										},
										sslVerify: false,
